    ...
    Scaffold(
        ...
        if (state.carregando) {
            ...
            LazyColumn(
                ...
                item {
                    MeusResgatesCard(onClick = { onNavigate("resgates") })
                }
...
/** Atalho para a tela "Meus Resgates", entre os dados do usuario e o QR Code. */
@Composable
private fun MeusResgatesCard(onClick: () -> Unit) {
    ElevatedCard(
        onClick = onClick,
        modifier = Modifier.fillMaxWidth(),
